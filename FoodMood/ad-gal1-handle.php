        ...
        <div class="boxx">
            ...
            <table border="1">
                ...
                <?php
                    ...
                    error_reporting(0);
                    $query = "select * from gallery1 order by id";
                            ...
                            while($res = mysqli_fetch_assoc($data)){
                                echo "
                                    <tr>
                                        ...
                                        <td>".$res['place']."</td>
                                        <td><a href='ad-gal1-del.php?rn=$res[id]' onclick='return checkdelete()'><button class='btn btn-danger'>Delete</button></a></td/>
                                        <td><a href='gal1-edit.php?rn=$res[id]&fn=$res[source]&ln=$res[place]'><button class='btn btn-success'>Edit</button></a></td>
                                    </tr>
                                ";
                            }
                    }
