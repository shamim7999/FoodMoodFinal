              ...
              <body>
                ...
                <script type="text/javascript">
                    func = function(){
                        ...
                        var abc = document.getElementById("place").value;
                        ...
                        <?php
                         ...
                         $query = "SELECT * FROM Dhaka WHERE myfile='$cookie'";
                            $data = mysqli_query($conn, $query);
                            $tem="";
                            while($result = mysqli_fetch_assoc($data)){
                                $tem = $result['price'];
                 ...
                 //   $rn = $_POST['id'];
                    ...
                    if($fn!="" && $ln!="" && $em!="" && $gender!="" && $arrive!="" && $leave!=""){
                        ...
                        if($data){
                            ...
                            ?>
                            <META HTTP-EQUIV="Refresh" CONTENT="0; URL=http://localhost/travel3/Dhaka.php">
                            <?php
